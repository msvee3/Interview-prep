    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-50 via-dark-100 to-dark-200 py-12 px-6">
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="card text-center py-12">
          ...
          <h2 className="text-2xl font-bold text-dark-800 mb-4">Practice Mode</h2>
          <p className="text-dark-600 mb-6">Quick practice questions coming soon!</p>
          <button onClick={() => navigate('/interview/setup')} className="btn-primary">
            Start Full Interview Instead
          </button>
        </div>
      </div>
    </div>
